...
public class SceneAManager : MonoBehaviour
{
    ...
    public float distance = 100f;        // Distancia de la c�mara al objetivo
    public float rotationSpeed = 65f;   // Velocidad de rotaci�n orbital

    private int currentTargetIndex = 0; // �ndice del objetivo actual
    private float currentAngle = 0f;

    public float zoomSpeed = 100f;       // Qu� tan r�pido hace zoom
    public float minDistance = 50f;     // Distancia m�nima
    public float maxDistance = 500f;   // Distancia m�xima
